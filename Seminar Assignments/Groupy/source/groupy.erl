...
start(Module, Sleep) ->
    ...
    register(a, P),         
    spawn('p2@127.0.0.1', fun() -> register(b, worker:start("P2", Module, P, Sleep)) end),
    spawn('p3@127.0.0.1', fun() -> register(c, worker:start("P3", Module, P, Sleep)) end),
    spawn('p4@127.0.0.1', fun() -> register(d, worker:start("P4", Module, P, Sleep)) end),
    spawn('p5@127.0.0.1', fun() -> register(e, worker:start("P5", Module, P, Sleep)) end).
